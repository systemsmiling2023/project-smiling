                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0 center">
                        <div class="card" style="background:#616A6B">
                            <div class="card-body py-5 px-md-5">
                                <!-- <h3 class="text-white">Inicio Sesión</h3> -->
                                <form>

                                    <!-- User input -->
                                    <div class="form-outline mt-5 mb-3">
                                        <input type="text" id="usuario" name="usuario" placeholder="USUARIO" class="" autocomplete="off" />
                                        <br>
                                        <label class="form-label" id="labelUsuario">USUARIO</label>
                                    </div>

                                    <!-- Password input -->
                                    <div class="form-outline mb-4">
                                        <input type="password" id="clave" name="clave" placeholder="CONTRASEÑA" class="" />
                                        <br>
                                        <label class="form-label" id="labelClave">CONTRASEÑA</label>
                                    </div>
                                    <br>
