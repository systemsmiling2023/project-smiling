                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="card-title">Administración | Tipo de Documentos</h3>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" id="btnAddTipoDoc" class="btn btn-primary btn-block">
                        ...
                        <div class="card-body">
                            <table id="tipodoc" class="table table-striped table-bordered table-hover" style="width:100%">
                                <thead>
                                    <tr>
...
<?= $this->include('modals/modal_tipodocumento') ?>
...
<script src="<?= base_url('assets/js/tipoDocumento.js') ?>"></script>
