                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="card-title">Administración | Unidades de Medida</h3>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" id="btnAddUnidadesMedida" class="btn btn-primary btn-block">
                        ...
                        <div class="card-body">
                            <table id="unidadesMedida" class="table table-striped table-bordered table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="5%">No.</th>
                                        <th>Unidad de medida</th>
                                        <th>Abreviatura</th>
                                        <th>Medida Internacional</th>
                                        <th class="text-center" width="10%">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody id="bodyUnidadesMedida">
...
<?= $this->include('modals/modal_unidadesMedida') ?>
...
<script src="<?= base_url('assets/js/unidadesMedida.js') ?>"></script>
