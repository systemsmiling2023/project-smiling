                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="card-title">Administración | Medicamentos</h3>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" id="btnAddMedicamento" class="btn btn-primary btn-block">
                        ...
                        <div class="card-body">
                            <table id="medicamento" class="table table-striped table-bordered table-hover"
                                style="width:100%">
                                ...
                                <tbody id="bodyMedicamentos" style="text-transform:uppercase">
...
<?= $this->include('modals/modal_medicamento') ?>
...
<script src="<?= base_url('assets/js/medicamentos.js') ?>"></script>
