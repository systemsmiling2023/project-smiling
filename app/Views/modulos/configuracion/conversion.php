                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="card-title">Administración | Conversiones</h3>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" id="btnAddConversion" class="btn btn-primary btn-block">
                        ...
                        <div class="card-body">
                            <table id="conversion" class="table table-striped table-bordered table-hover"
                                style="width:100%">
                                ...
                                <tbody id="bodyConversiones" style="text-transform:uppercase">
...
<?= $this->include('modals/modal_conversion') ?>
...
<script src="<?= base_url('assets/js/conversiones.js') ?>"></script>
