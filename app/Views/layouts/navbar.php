    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span id="notificacion-contador" class="badge badge-warning navbar-badge">0</span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="notificaciones-lista">
...
<!-- JavaScript -->
<script src="<?= base_url('assets/js/notificarMinimos.js') ?>"></script>
