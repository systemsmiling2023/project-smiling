                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="card-title">Administración | Intereses o Gustos</h3>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" id="btnAddInteres" class="btn btn-primary btn-block">
...
<?= $this->include('modals/modal_intereses') ?>
...
<script src="<?= base_url('assets/js/intereses.js') ?>"></script>
