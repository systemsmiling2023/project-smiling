                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="card-title">Administración | Personas</h3>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" id="btnAddPersonas" class="btn btn-primary btn-block">
                        ...
                        <div class="card-body">
                            <table id="personas" class="table table-striped table-bordered table-hover" style="width:100%">
                                <thead>
                                    <tr>
...
<?= $this->include('modals/modal_personas') ?>
<?= $this->include('modals/modal_personas_documentos') ?>
<?= $this->include('modals/modal_personas_contactos') ?>
...
<script src="<?= base_url('assets/js/personas.js') ?>"></script>
