                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="card-title">Administración | Profesiones</h3>
                                </div>
                                <div class="col-md-2">
...
<?= $this->include('modals/modal_profesiones') ?>
...
<script src="<?= base_url('assets/js/profesiones.js') ?>"></script>
